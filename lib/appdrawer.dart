                          ...
                          return Container(
                            ...
                            child: Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    DeviceApps.openApp(
                                        SystemConfig.apps[i].packageName);
                                  },
                                  child: Center(
                                      child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Center(
                                          child: Text(SystemConfig
                                                      .apps[i].appNmae
                                                      .toString()
                                                      .length >
                                                  8
                                              ? SystemConfig.apps[i].appNmae
                                                      .toString()
                                                      .substring(0, 8) +
                                                  ".."
                                              : SystemConfig.apps[i].appNmae
                        ...
                        children: List.generate(
                          ...
                          return Container(
                            ...
                            child: Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    DeviceApps.openApp(SystemConfig.apps
                                        .where((apps) => apps.appNmae
                                            .toLowerCase()
                                            .startsWith(
                                      ...
                                      Center(
                                          child: Text(SystemConfig.apps
                                              ...
                                              ? SystemConfig.apps
                                                      ...
                                                      .substring(0, 8) +
                                                  ".."
                                              : SystemConfig.apps.where((apps) => apps.appNmae.toLowerCase().startsWith(_controller.text.toLowerCase())).toList()[i].appNmae.toString()))
                                    ],
                                  )),
                                )),
                          );
